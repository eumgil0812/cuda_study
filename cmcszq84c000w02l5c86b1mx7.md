...
## 2\. What Should the Kernel Look Like After the Bootloader?
...
Goal**:** This prepares the kernel binary for execution by placing it in a memory region large enough to hold the full file.
